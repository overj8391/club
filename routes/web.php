    ...
    ->middleware(['auth', 'checker'])->group(function ()
{
    Route::namespace ('Backend')->group(function ()
    {
        ...
        Route::get('/money_stat', ['as' => 'backend.money_stat', 'uses' => 'DashboardController@money_stat', 'middleware' => 'permission:stats.game', ]);
        Route::get('/money_stat/clear', ['as' => 'backend.money_stat_clear', 'uses' => 'DashboardController@money_stat_clear', 'middleware' => 'permission:stats.game', ]);
...
Route::namespace ('Frontend')->middleware(['siteisclosed', 'checker'])->group(function ()
{
    ...
    Route::get('{category}', ['as' => 'frontend.game.list.category', 'uses' => 'GamesController@index']);
});
