    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Создать несколько ПИН-КОДов</h3>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.0000001" class="form-control" id="title" name="nominal">
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Создать ПИН-КОД</h3>
        </div>
