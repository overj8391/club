        ...
        <div class="modal-content">
            <form action="{{ route('backend.user.balance.update') }}" method="POST" id="outForm">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Снять средства пользователю</h4>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">@lang('app.close')</button>
                    <button type="button" class="btn btn-danger" id="doOutAll">Снять ВСЕ средства</button>
                    <button type="submit" class="btn btn-primary">Снять указанную сумму</button>
                </div>
            </form>
        </div>
    </div>
